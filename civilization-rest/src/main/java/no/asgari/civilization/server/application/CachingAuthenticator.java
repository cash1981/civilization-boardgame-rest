...
/**
 * An {@link io.dropwizard.java8.auth.Authenticator} decorator which uses a Guava cache to temporarily cache credentials and
 * their corresponding principals.
 *
 * usage:
 * private final io.dropwizard.java8.auth.CachingAuthenticator<String, String> cached =
 * new CachingAuthenticator<>(new MetricRegistry(), new CivAuthenticator(playerCollection, null),
